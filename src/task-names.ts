export const TASK_PREFIX = "tookey"

export const AUTH_TASKS = TASK_PREFIX + ":auth"

export const AUTH_SIGNIN_TASK = AUTH_TASKS + ":signin"
export const AUTH_REFRESH_TASK = AUTH_TASKS + ":refresh"
